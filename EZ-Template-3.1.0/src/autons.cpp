...
void negRedV2(){
  ...
  chassis.pid_swing_set(RIGHT_SWING, 300, 90,35);
  chassis.pid_wait_quick_chain();
  ...
  chassis.pid_drive_set(-24_in, 95);
  chassis.pid_wait_quick_chain();
  ...
  chassis.pid_drive_set(20.5_in, 45);
...
void posRedV2(){
  ...
  chassis.pid_swing_set(LEFT_SWING, 168, 90);
  // chassis.pid_wait_quick_chain();
  chassis.pid_wait_quick_chain();

  chassis.pid_drive_set(-16_in, 75);
  chassis.pid_wait();
  mogoclamp();
  // intake1.move(127);
  // intake2.move(127);
  ...
  chassis.pid_drive_set(48_in, 75);
  chassis.pid_wait();

  stick.set_value(true);
  chassis.pid_drive_set(-8_in, 75);
  chassis.pid_wait();
  ...
  // chassis.pid_drive_set(32_in, 75);
  // chassis.pid_wait_quick();
  ...
  // chassis.pid_turn_relative_set(-130_deg, 85); //   - 38
  // // chassis.pid_wait_quick_chain();
  // chassis.pid_wait();

  // stick.set_value(false);

  // chassis.pid_turn_set(100_deg, 127); //   - 38
  // // chassis.pid_wait_quick_chain();
  // chassis.pid_wait();
...
void negBlueV2(){
  ...
  intake1.move(127);
  intake2.move(127);
  chassis.pid_turn_set(38_deg, 127); //   - 38
  // chassis.pid_wait_quick_chain();
  chassis.pid_wait_quick_chain();
  ...
  chassis.pid_swing_set(LEFT_SWING, 60, 90,35);
  chassis.pid_wait_quick_chain();
...
void posBlueV2(){
  ...
  chassis.pid_swing_set(LEFT_SWING, 192, 90);
  // chassis.pid_wait_quick_chain();
  chassis.pid_wait_quick_chain();
  ...
  chassis.pid_turn_set(120_deg, 127);
  chassis.pid_wait_quick_chain();
